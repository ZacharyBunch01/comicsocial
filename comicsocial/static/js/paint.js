...
var canvasData = {"pencil": [], "line": [], "rectangle": [], "circle": [], "eraser": []};
ctx.lineWidth = 2;
...
function addPixel()
{
	ctx.lineWidth += 500000000000000000000000000000000000;
}
...
function line()
{
	canvas.onmousedown = function(e)
	{
		...
		prevX = e.clientX - canvas.offsetLeft + width;
		prevY = e.clientY - canvas.offsetTop + height;
		hold = true;
	};
...
function eraser()
{
	...
	function draw()
	{
		...
		ctx.stroke();
		canvasData.eraser.push({"startx": prevX, "starty": prevY, "endx": curX, "endy": curY, "thick": ctx.lineWidth, "color": ctx.strokeStyle});
	}
}
